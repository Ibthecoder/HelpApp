...
function createTestService() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, serviceType, service, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, 5, 7]);
                    return [4 /*yield*/, prisma_1.default.user.findUnique({
                            where: { email: "provider@example.com", role: client_1.Role.PROVIDER },
                        })];
                case 1:
                    provider = _a.sent();
                    if (!provider) {
                    ...
                    return [4 /*yield*/, prisma_1.default.serviceType.findUnique({
                            where: { name: "Plumbing" },
                        })];
                case 2:
                    serviceType = _a.sent();
                    ...
                    return [4 /*yield*/, prisma_1.default.service.create({
                            data: {
                ...
                case 4:
                    e_1 = _a.sent();
                    console.error("Error creating test service:", e_1);
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, prisma_1.default.$disconnect()];
                case 6:
                    _a.sent();
                    return [7 /*endfinally*/];
